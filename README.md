...
PDF library                      EPUB library (academic books)
   │                                │
   ▼  pdf2md/pdf2md_marker.py       ▼  pdf2md/epub2md.py
   │  pdf2md/pdf2md_fallback.py     │     ← pandoc (primary) or markitdown (fallback)
   │     ← pymupdf4llm rescue       │     ← OPF metadata → title, authors, editors,
